    ...
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto">
            ...
            <div className="px-4 border-b border-gray-100">
              <div className="py-4 space-y-1">
                ...
                >
                  ...
                  <span className="bg-green-500 py-1 px-2.5 rounded-full text-white text-[11px] font-bold">
                    {cartCount}
                  </span>
                </Link>
              </div>
          ...
          {/* Profile & Sign Out OR Login & Register */}
          <div className="p-4">
            {user ? (
              <>
                <Link
                  href="/profile"
                  onClick={() => setMenuOpen(false)}
                  className="flex items-center gap-3 py-3 px-4 hover:bg-green-50 rounded-xl transition-colors mb-2"
                >
                  <div className="w-9 h-9 flex items-center justify-center bg-[#F3F4F6] rounded-full">
